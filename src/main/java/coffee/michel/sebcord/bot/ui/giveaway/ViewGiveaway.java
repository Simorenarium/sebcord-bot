 ...
 *
 */
@Route(value = "giveaway/view", layout = MainRouterLayout.class)
public class ViewGiveaway extends VerticalLayout implements UIFeature.UIVisualization {
	private static final long serialVersionUID = -3610527236463711403L;

	@Override
	@SuppressWarnings({ "rawtypes", "unchecked", "cast" })
	public Class<? extends UIFeature> getFeature() {
		return (Class) ViewGiveawayFeature.class;
	}
